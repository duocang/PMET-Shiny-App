...
ui <- fluidPage(
  ...
  navbarPage(
    ...
    header = list(
      ...
      # github-corner
      HTML('<a href="https://github.com/duocang/PMET-Shiny-App" class="github-corner" aria-label="View source on GitHub">
                      <svg width="64" height="64" viewBox="0 0 250 250" style="fill:#000; color:#fff; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
