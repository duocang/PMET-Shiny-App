...
ui <- fluidPage(
  ...
  navbarPage(
    ...
    header = list(
      ...
      # github-corner
      HTML('<div id="github-corner-a"  class="github-corner" aria-label="View source on GitHub">
            <a id="github-corner-a" href="https://github.com/duocang/PMET-Shiny-App" class="github-corner" aria-label="View source on GitHub" target="_blank">
              <svg id="github-corner" width="64" height="64" viewBox="0 0 250 250" style="fill:#000; color:#fff; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
  ...
  fixedPanel(bottom = 10,
    right = 15,
    tags$a(href="https://github.com/duocang/PMET-Shiny-App",
      target="_blank",
      style="color: #b2bbbe;", "Maintained by Wang Xuesong"),
      " - \u00A9",
    format(Sys.Date(), "%Y")
  )
)
